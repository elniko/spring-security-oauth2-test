...
public class FundsConfirmationsApiController implements FundsConfirmationsApi {
    ...
    public ResponseEntity<HalPaymentCoverageReport> fundsConfirmationsPost(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                                           @ApiParam(value = "parameters of a payment coverage request" ,required=true )  @Valid @RequestBody PaymentCoverageRequestResource paymentCoverage,
        ...
        // do some magic!
        return new ResponseEntity<HalPaymentCoverageReport>(HttpStatus.OK);
    }
