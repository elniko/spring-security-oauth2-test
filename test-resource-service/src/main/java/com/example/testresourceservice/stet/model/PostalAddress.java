 ...
 */
@ApiModel(description = "ISO20022 : Information that locates and identifies a specific address, as defined by postal services. ")
...
public class PostalAddress   {
   ...
   * @return country
  **/
  @ApiModelProperty(required = true, value = "ISO20022: Country in which a person resides (the place of a person's home). In the case of a company, it is the country from which the affairs of that company are directed. ")
  @NotNull
 ...
 @Pattern(regexp="^([A-Z]{2,2})$")
   ...
   * @return addressLine
  **/
  @ApiModelProperty(required = true, value = "Unstructured address. The two lines must embed zip code and town name")
  @NotNull
