 ...
 */
@ApiModel(description = "PSU account that is made available to the TPP ")
...
public class AccountResource   {
   ...
   * @return resourceId
  **/
  @ApiModelProperty(required = true, value = "Identification of the account as defined as a resource by the ASPSP")
  @NotNull
 ...
 @Size(max=70)
   ...
   * @return bicFi
  **/
  @ApiModelProperty(value = "ISO20022: Code allocated to a financial institution by the ISO 9362 Registration Authority as described in ISO 9362 \"Banking - Banking telecommunication messages - Business identification code (BIC)\". ")
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Label of the PSU account In case of a delayed debit card transaction set, the name shall specify the holder name and the imputation date ")
  @NotNull
  ...
  **/
  @ApiModelProperty(required = true, value = "Specifies the type of the account - CACC: Cash account ")
  @NotNull
 ...
 @Size(max=35)
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "Currency used for the account")
  @NotNull
 ...
 @Size(max=3)
   ...
   * @return balances
  **/
  @ApiModelProperty(value = "list of balances provided by the ASPSP")
 ...
 @Size(min=1)
   ...
   * @return psuStatus
  **/
  @ApiModelProperty(value = "Relationship between the PSU and the account - Account Holder - Co-account Holder - Attorney")
