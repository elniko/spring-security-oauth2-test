 ...
 */
@ApiModel(description = "ISO20022: Set of elements used to reference a payment instruction. ")
...
public class PaymentIdentification   {
  ...
  **/
  @ApiModelProperty(required = true, value = "ISO20022: Unique identification as assigned by an instructing party for an instructed party to unambiguously identify the instruction.  API: Unique identification shared between the PISP and the ASPSP ")
  @NotNull
 ...
 @Pattern(regexp="^([a-zA-Z0-9 /\\-?:\\()\\.,']{1,35})$")
   ...
   * @return endToEndId
  **/
  @ApiModelProperty(required = true, value = "ISO20022: Unique identification assigned by the initiating party to unambiguously identify the transaction. This identification is passed on, unchanged, throughout the entire end-to-end chain.  API: Unique identification shared between the merchant and the PSU ")
  @NotNull
