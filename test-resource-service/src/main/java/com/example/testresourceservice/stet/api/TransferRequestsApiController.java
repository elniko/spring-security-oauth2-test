...
import com.example.testresourceservice.stet.model.HalTransferRequest;
import com.example.testresourceservice.stet.model.PaymentTransferRequestConfirmationResource;
import com.example.testresourceservice.stet.model.TransferRequestResource;
...
@Controller
public class TransferRequestsApiController implements TransferRequestsApi {



    public ResponseEntity<HalTransferRequest> transferRequestsConfirmationPost(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                                               @ApiParam(value = "Identification of the Transfer Request Resource",required=true ) @PathVariable("transferRequestResourceId") String transferRequestResourceId,
        ...
        // do some magic!
        return new ResponseEntity<HalTransferRequest>(HttpStatus.OK);
    }

    public ResponseEntity<HalTransferRequest> transferRequestsGet(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                                  @ApiParam(value = "Identification of the Transfer Request Resource",required=true ) @PathVariable("transferRequestResourceId") String transferRequestResourceId,
                                                                  @ApiParam(value = "http-signature of the request (cf. https://datatracker.ietf.org/doc/draft-cavage-http-signatures/) The keyId part of the header should be formatted as follows   keiId=\"SN=XXX,CA=YYYYYYYYYYYYYYYY\" where   \"XXX\" is the serial number, in hexadecimal without any prefix (like 0x), of the QSEAL certificate whose relevant private key was used for signing   \"YYYYYYYYYYYYYYYY\" is the the Issuer DN, full Distinguished Name of the Certification Authority having issued this certificate HTTP400 will be returned by the server in case of invalid or absent signature " ,required=true) @RequestHeader(value="Signature", required=true) String signature,
                                                                  @ApiParam(value = "Correlation header to be set in a request and retrieved in the relevant response " ,required=true) @RequestHeader(value="X-Request-ID", required=true) String xRequestID,
                                                                  @ApiParam(value = "IP address used by the PSU's terminal when connecting to the TPP" ) @RequestHeader(value="PSU-IP-Address", required=false) String psUIPAddress,
    ...
    public ResponseEntity<HalPaymentTransferRequestCreation> transferRequestsPost(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                                                  @ApiParam(value = "ISO20022 based payment Initiation Request" ,required=true )  @Valid @RequestBody TransferRequestResource transferRequest,
                                                                                  @ApiParam(value = "http-signature of the request (cf. https://datatracker.ietf.org/doc/draft-cavage-http-signatures/) The keyId part of the header should be formatted as follows   keiId=\"SN=XXX,CA=YYYYYYYYYYYYYYYY\" where   \"XXX\" is the serial number, in hexadecimal without any prefix (like 0x), of the QSEAL certificate whose relevant private key was used for signing   \"YYYYYYYYYYYYYYYY\" is the the Issuer DN, full Distinguished Name of the Certification Authority having issued this certificate HTTP400 will be returned by the server in case of invalid or absent signature " ,required=true) @RequestHeader(value="Signature", required=true) String signature,
                                                                                  @ApiParam(value = "Correlation header to be set in a request and retrieved in the relevant response " ,required=true) @RequestHeader(value="X-Request-ID", required=true) String xRequestID,
                                                                                  @ApiParam(value = "IP address used by the PSU's terminal when connecting to the TPP" ) @RequestHeader(value="PSU-IP-Address", required=false) String psUIPAddress,
                                                                                  @ApiParam(value = "IP port used by the PSU's terminal when connecting to the TPP" ) @RequestHeader(value="PSU-IP-Port", required=false) String psUIPPort,
