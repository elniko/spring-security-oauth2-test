 ...
 */
@ApiModel(description = "API : Description of a Party which can be either a person or an organization. ")
...
public class PartyIdentification   {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "ISO20022: Name by which a party is known and which is usually used to identify that party. ")
  @NotNull
  ...
  **/
  @ApiModelProperty(value = "Unique and unambiguous way to identify an organisation.")
   ...
   * @return privateId
  **/
  @ApiModelProperty(value = "Unique and unambiguous identification of a person.")
