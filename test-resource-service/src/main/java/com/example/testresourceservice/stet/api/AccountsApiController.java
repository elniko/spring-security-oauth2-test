...
import com.example.testresourceservice.services.AccountService;
import com.example.testresourceservice.services.AuthKeeper;
...
public class AccountsApiController implements AccountsApi {
    ...
    public ResponseEntity<HalBalances> accountsBalancesGet(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                           @ApiParam(value = "Identification of account resource to fetch",required=true ) @PathVariable("accountResourceId") String accountResourceId,
                                                           @ApiParam(value = "This header specifies which party has been mandated by the PSU for guaranteeing the respect of the PSU's choices on accessibility scope on each individual account. The AISP must use one the following values - BY-AISP: means that the AISP has been mandated by the PSU on the detailed account access management. Thus the ASPSP is not obliged to check whether or not a given AISP request is authorized. - BY-ASPSP: means that the ASPSP is obliged to guarantee the respect of the detailed account access grants given by the PSU to the AISP and thus to check every request from the AISP. " ,required=true, allowableValues="BY-AISP, BY-ASPSP") @RequestHeader(value="PSU-Account-Consent-Responsibility", required=true) String psUAccountConsentResponsibility,
        ...
        // do some magic!
        return new ResponseEntity<HalBalances>(HttpStatus.OK);
    }

    public ResponseEntity<HalAccounts> accountsGet(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                   @ApiParam(value = "This header specifies which party has been mandated by the PSU for guaranteeing the respect of the PSU's choices on accessibility scope on each individual account. The AISP must use one the following values - BY-AISP: means that the AISP has been mandated by the PSU on the detailed account access management. Thus the ASPSP is not obliged to check whether or not a given AISP request is authorized. - BY-ASPSP: means that the ASPSP is obliged to guarantee the respect of the detailed account access grants given by the PSU to the AISP and thus to check every request from the AISP. " ,required=true, allowableValues="BY-AISP, BY-ASPSP") @RequestHeader(value="PSU-Account-Consent-Responsibility", required=true) String psUAccountConsentResponsibility,
                                                   @ApiParam(value = "http-signature of the request (cf. https://datatracker.ietf.org/doc/draft-cavage-http-signatures/) The keyId part of the header should be formatted as follows   keiId=\"SN=XXX,CA=YYYYYYYYYYYYYYYY\" where   \"XXX\" is the serial number, in hexadecimal without any prefix (like 0x), of the QSEAL certificate whose relevant private key was used for signing   \"YYYYYYYYYYYYYYYY\" is the the Issuer DN, full Distinguished Name of the Certification Authority having issued this certificate HTTP400 will be returned by the server in case of invalid or absent signature " ,required=true) @RequestHeader(value="Signature", required=true) String signature,
                                                   @ApiParam(value = "Correlation header to be set in a request and retrieved in the relevant response " ,required=true) @RequestHeader(value="X-Request-ID", required=true) String xRequestID,
                                                   @ApiParam(value = "IP address used by the PSU's terminal when connecting to the TPP" ) @RequestHeader(value="PSU-IP-Address", required=false) String psUIPAddress,
        ...
        HalAccounts hal = accountService.getAccounts(authKeeper.getAuthentication().getName());
        // do some magic!
        return new ResponseEntity<HalAccounts>(hal, HttpStatus.OK);
    }

    public ResponseEntity<HalTransactions> accountsTransactionsGet(@ApiParam(value = "Access token to be passed as a header" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization,
                                                                   @ApiParam(value = "Identification of account resource to fetch",required=true ) @PathVariable("accountResourceId") String accountResourceId,
                                                                   @ApiParam(value = "This header specifies which party has been mandated by the PSU for guaranteeing the respect of the PSU's choices on accessibility scope on each individual account. The AISP must use one the following values - BY-AISP: means that the AISP has been mandated by the PSU on the detailed account access management. Thus the ASPSP is not obliged to check whether or not a given AISP request is authorized. - BY-ASPSP: means that the ASPSP is obliged to guarantee the respect of the detailed account access grants given by the PSU to the AISP and thus to check every request from the AISP. " ,required=true, allowableValues="BY-AISP, BY-ASPSP") @RequestHeader(value="PSU-Account-Consent-Responsibility", required=true) String psUAccountConsentResponsibility,
                                                                   @ApiParam(value = "http-signature of the request (cf. https://datatracker.ietf.org/doc/draft-cavage-http-signatures/) The keyId part of the header should be formatted as follows   keiId=\"SN=XXX,CA=YYYYYYYYYYYYYYYY\" where   \"XXX\" is the serial number, in hexadecimal without any prefix (like 0x), of the QSEAL certificate whose relevant private key was used for signing   \"YYYYYYYYYYYYYYYY\" is the the Issuer DN, full Distinguished Name of the Certification Authority having issued this certificate HTTP400 will be returned by the server in case of invalid or absent signature " ,required=true) @RequestHeader(value="Signature", required=true) String signature,
                                                                   @ApiParam(value = "Correlation header to be set in a request and retrieved in the relevant response " ,required=true) @RequestHeader(value="X-Request-ID", required=true) String xRequestID,
                                                                   @ApiParam(value = "Inclusive minimal imputation date of the transactions.  Transactions having an imputation date equal to this parameter are included within the result. ") @RequestParam(value = "dateTo", required = false) DateTime dateTo,
                                                                   @ApiParam(value = "Exclusive maximal imputation date of the transactions.  Transactions having an imputation date equal to this parameter are not included within the result. ") @RequestParam(value = "dateFrom", required = false) DateTime dateFrom,
                                                                   @Size(max=16)@ApiParam(value = "Specifies the value on which the result has to be computed.  Only the transaction having a technical identification greater than this value must be included within the result ") @RequestParam(value = "afterEntryReference", required = false) String afterEntryReference,
                                                                   @ApiParam(value = "IP address used by the PSU's terminal when connecting to the TPP" ) @RequestHeader(value="PSU-IP-Address", required=false) String psUIPAddress,
                                                                   @ApiParam(value = "IP port used by the PSU's terminal when connecting to the TPP" ) @RequestHeader(value="PSU-IP-Port", required=false) String psUIPPort,
                                                                   @ApiParam(value = "Http method for the most relevant PSUâ€™s terminal request to the TTP" ) @RequestHeader(value="PSU-HTTP-Method", required=false) String psUHTTPMethod,
                                                                   @ApiParam(value = "Timestamp of the most relevant PSUâ€™s terminal request to the TTP" ) @RequestHeader(value="PSU-Date", required=false) String psUDate,
                                                                   ...
                                                                   @ApiParam(value = "Digest of the body" ) @RequestHeader(value="Digest", required=false) String digest) {
        // do some magic!
        return new ResponseEntity<HalTransactions>(HttpStatus.OK);
    }
