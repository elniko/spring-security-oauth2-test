...
public class PaymentRequestResource   {
  ...
  **/
  @ApiModelProperty(required = true, value = "ISO20022 : Reference assigned by a sending party to unambiguously identify the payment information block within the message. ")
  @NotNull
  ...
  **/
  @ApiModelProperty(required = true, value = "ISO20022: Number of individual transactions contained in the message. ")
  @NotNull
  ...
  **/
  @ApiModelProperty(required = true, value = "ISO20022: Payment processes required to transfer cash from the debtor to the creditor. ")
  @NotNull
